...
GAME_MESSAGE = "⩹━★⊷━⌞SOURCE CRAZY\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب كرايزي\n\n⩹━★⊷━⌞SOURCE CRAZY"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('SOURCE CRAZY', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞SOURCE CRAZY', url =f"https://t.me/CH_CRAZ")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞SOURCE CRAZY\n\nمرحبا بك في قسم العاب كرايزي 3D\n\n⩹━★⊷━⌞SOURCE CRAZY"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━SOURCE CRAZY\n\n★¦مرحبا بك في قسم العاب كرايزي\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞SOURCE CRAZY" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب كرايزي', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞SOURCE CRAZY', url =f"https://t.me/CH_CRAZ")              
                 ],[
                InlineKeyboardButton(
